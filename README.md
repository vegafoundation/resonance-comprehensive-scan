...
This repository contains the conceptual definition and theoretical framework for **Comprehensive Scan**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── comprehensive-scan.tex    # LaTeX dissertation
├── whitepaper/
│   └── comprehensive-scan.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025comprehensivescan,
  author = {Vega, Adam Eren},
  title = {Comprehensive Scan: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/comprehensive-scan}
}
```
